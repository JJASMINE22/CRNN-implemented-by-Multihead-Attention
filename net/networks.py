...
from CustomLayers import BidirectionalLSTM, MultiHeadAttention
...
class CRNN(nn.Module):
    def __init__(self):
        ...
        # for bilstm model
        # self.bilstm1 = BidirectionalLSTM(input_size=512,
        #                                  hidden_size=256,
        #                                  target_size=256)
        #
        # self.bilstm2 = BidirectionalLSTM(input_size=256,
        #                                  hidden_size=256,
        #                                  target_size=66)
